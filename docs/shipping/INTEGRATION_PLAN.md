...
เอกสารนี้เป็น **ข้อเสนอสำหรับพัฒนา** ตาม [Working Brief](WORKING-BRIEF.md) ไม่ใช่รายละเอียดฟังก์ชันที่ติดตั้งแล้ว อ้างอิงโค้ด S6 และสเปก S1 ใน [SOURCES.md](SOURCES.md)
