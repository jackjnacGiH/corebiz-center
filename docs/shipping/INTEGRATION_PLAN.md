...
บัญชี UAT เลือก `prepaid` แล้วและบันทึกเบอร์/อีเมลผู้ส่งที่ API ต้องใช้แล้ว ส่วน carrier ที่เปิดใช้จริงใน Production, provider warehouse mapping, รายชื่อพนักงาน, รุ่นเครื่องพิมพ์, ปริมาณงาน และนโยบายส่งหลายกล่อง/บางรายการยังอยู่ใน QUESTIONS
...
บัญชี UAT ใน CoreBiz ตั้งเป็น `prepaid` แล้ว การสร้าง shipment จึงต้องตรวจยอด Wallet ตาม contract ของ PromptSpeed ก่อนทุกครั้ง หาก Credit ได้รับอนุมัติและต้องการเปลี่ยนโหมด ให้แก้ค่าผ่าน owner/admin พร้อม audit ไม่สลับโหมดจากผลเดาใน UI
