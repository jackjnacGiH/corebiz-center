...
- ตัวอย่างและพิมพ์ลาเบล J NAC ขนาด 100 × 150 มม. หลังมี Tracking แสดงโลโก้บริษัท ชื่อ/ตราขนส่ง Barcode ผู้ส่ง ผู้รับ เบอร์โทร COD จำนวนสินค้า กล่อง 1/1 และหมายเหตุหน้ากล่อง
...
- โลโก้บริษัทอ่านจาก `org_settings.logo_url`; ขนส่งที่รู้จักใช้ mapping ของชื่อ สี และรูปตราที่ตั้งไว้ พร้อมกลับมาแสดงตราอักษรกับชื่อทันทีเมื่อรูปโหลดไม่ได้ บริการใหม่จึงไม่ทำให้หัวลาเบลว่าง
