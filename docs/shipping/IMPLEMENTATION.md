...
- รายการที่บันทึกแล้วทั้งฉบับร่างและรายการที่มี Tracking เปิดตัวอย่างและพิมพ์ลาเบล J NAC ขนาด 100 × 150 มม. ได้จากหน้าขนส่งโดยตรง รายการที่ยังไม่มี Tracking ใช้เลขอ้างอิงแทน พร้อมแสดงโลโก้บริษัท ชื่อ/ตราขนส่ง Barcode ผู้ส่ง ผู้รับ เบอร์โทร COD จำนวนสินค้า QR เพิ่มเพื่อน LINE `@jnac` และหมายเหตุหน้ากล่อง
...
- ใบปะหน้าขนาด 100 × 150 มม. แบ่งความสูงด้วย grid เพื่อกันพื้นที่อ้างอิงและสินค้าออกจากฟุตเตอร์ ชื่อบริษัทบนหัวใช้ขนาด 12px โลโก้ขนส่งไม่มีกรอบ และเพิ่มความสูงแท่ง Barcode สองเท่า โดยเพิ่มทั้งความสูงการสร้าง SVG และพื้นที่แสดงจาก 12 เป็น 24 มม. รักษาความกว้างเดิมเพื่อให้เลขอ้างอิงยาวยังได้แท่งสูงขึ้นสองเท่า รายการสินค้าแสดงได้ 5 บรรทัดพร้อมจำนวนแต่ละรายการ
...
- เทียบ Barcode ของเลขอ้างอิงยาวชุดเดียวกันก่อน/หลังปรับ: ความสูงแท่งที่แสดงจริงเพิ่มจากประมาณ 21.45px เป็น 42.91px โดยความกว้างเท่าเดิม
