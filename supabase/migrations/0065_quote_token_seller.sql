-- =========================================================================
-- 0065_quote_token_seller.sql
-- Add the seller (org) header — name, tax id, address, contact + logo — to the
-- public quote payload so the quote document shows the real JNAC company
-- branding instead of a hardcoded "CoreBiz Center" placeholder.
-- =========================================================================
