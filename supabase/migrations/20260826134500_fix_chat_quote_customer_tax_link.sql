-- =========================================================================
-- 20260826134500_fix_chat_quote_customer_tax_link.sql
-- Qualify chat_conversations columns that overlap the function return names.
-- =========================================================================
...
begin
  ...
  update public.chat_conversations cc
     set customer_id = v_customer,
         ...
         updated_at = now()
   where cc.id = p_conversation_id
     and (cc.customer_id is null or cc.customer_id = v_customer);
