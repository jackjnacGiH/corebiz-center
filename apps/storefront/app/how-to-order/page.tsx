...
export const metadata: Metadata = {
  ...
  description:
    "วิธีสั่งซื้อสินค้ากับ JNAC ผ่าน corebiz.online/shop ทำตาม 6 ขั้นตอน: เลือกสินค้า → หยิบใส่ตะกร้า → กรอกข้อมูลติดต่อ → ส่งคำขอใบเสนอราคา ทีมงานติดต่อกลับ พร้อมจัดส่งทั่วประเทศ",
  alternates: { canonical: "/shop/how-to-order" },
};

const STEPS: [string, string][] = [
  ["เข้าเว็บไซต์ร้านค้า", "เปิด www.corebiz.online/shop ใช้งานได้ทั้งคอมพิวเตอร์ มือถือ และแท็บเล็ต โดยไม่ต้องสมัครสมาชิก"],
