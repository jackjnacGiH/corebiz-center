      ...
      <div className="overflow-y-auto flex-1 p-4 space-y-4">
        ...
        <div className="flex flex-col items-center text-center">
          <ChatAvatar
            ...
            fallbackClassName="w-16 h-16 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 grid place-items-center text-white text-2xl font-bold mb-2"
            fallback={conversation.display_name.charAt(0).toUpperCase()}
            loading="eager"
          />
