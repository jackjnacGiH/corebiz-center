/**
 * Inbox — Omni-channel chat inbox for admin staff.
 *
 ...
 * messages light up instantly without manual refresh.
 *
 * Phase 1 surface: only livechat (web AI Chat) populates this. Phase 2-3
 * will plug LINE / FB Messenger / Email through the SAME tables — this
