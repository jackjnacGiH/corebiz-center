...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'h', text: 'รายงาน AI ประจำเดือน (สรุปผล + ข้อเสนอแนะ)' },
      { t: 'p', text: 'แถบด้านบนสุดของหน้า AI Agent — ทุก 30 วัน AI จะสรุปพฤติกรรมลูกค้าและการดำเนินงานทั้งหมด แล้วเสนอข้อปรับปรุงเรียงตามลำดับความสำคัญ เพื่อให้เจ้าของตัดสินใจว่าจะพัฒนา/เพิ่มส่วนไหนต่อ' },
      { t: 'ul', items: [
      ...
      { t: 'steps', items: [
        'ระบบสร้างให้อัตโนมัติทุกวันที่ 1 ของเดือน และ push สรุปเข้า LINE ของเจ้าของ',
