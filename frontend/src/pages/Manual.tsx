...
const SECTIONS: Section[] = [
  ...
  },
  {
    id: 'marketing',
    icon: '📈',
    title: 'การตลาดและพาร์ทเนอร์ (Marketing & Affiliate)',
    blocks: [
      { t: 'p', text: 'เครื่องมือการตลาด: แคมเปญ, คูปอง, โปรแกรมแนะนำเพื่อน และระบบพาร์ทเนอร์/ตัวแทน' },
      { t: 'ul', items: [
        'ยิงแคมเปญตามกลุ่มลูกค้า (RFM/Tier) ผ่าน LINE — ส่งทีละราย เว้นจังหวะ สุ่มสลับข้อความ (กันถูกมองเป็นบอท)',
        'พาร์ทเนอร์/Affiliate: จัดการตัวแทนและส่วนแบ่ง',
      ] },
