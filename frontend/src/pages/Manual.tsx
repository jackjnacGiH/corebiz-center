...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'p', text: 'แท็บแรกในหน้า AI Agent — ทุก 30 วัน AI จะสรุปพฤติกรรมลูกค้าและการดำเนินงานทั้งหมด แล้วเสนอข้อปรับปรุงเรียงตามลำดับความสำคัญ เพื่อให้เจ้าของตัดสินใจว่าจะพัฒนา/เพิ่มส่วนไหนต่อ' },
      { t: 'ul', items: [
